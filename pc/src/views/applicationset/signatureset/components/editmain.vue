<template>
  <div class="editmain">
    ...
    <Maincontent>
      <div class="MaskTop" v-if="computedAuth"></div>
      <div class="maincontent-tab">
            ...
            <a-form-model-item label class="item-w">
              <div class="flex-col">
                ...
                <a-checkbox
                  ...
                  class="maincontent-item-checkout"
                  >设为我的常用签章</a-checkbox
                >
              </div>
            </a-form-model-item>
          ...
          <div class="maincontent-tab-col-content">
            <a-form-model-item label class="item-w">
              <div class="userBox">
                ...
                <div @click="usersUsed()" class="iconImg">
                  <img
          ...
          <div class="maincontent-tab-col-content">
            <a-form-model-item label class="item-w">
              <div class="userBox">
                ...
                <div @click="empowering()" class="iconImg">
                  <img
                    src="../../../../assets/signatureset/chioseUser.png"
                    alt
                    style="width: 16px; height: 15px"
        ...
        <div class="maincontent-tab-col">
          ...
          <div class="maincontent-tab-col-content">
            <div class="MaskBott" v-if="computedAuth"></div>
            <a-form-model-item label class="item-w">
        ...
        <div class="maincontent-tab-col">
          ...
          <div class="maincontent-tab-col-content" style="height: 210px">
            <div class="MaskBott" v-if="computedAuth"></div>
            <a-form-model-item label class="item-w">
              <div v-if="form.img != ''" class="imgList">
                <img
                  :src="'data:image/png;base64,' + form.img_data"
                  alt
                  v-if="id != ''"
                />
                <!-- <img :src="imgUrl"
  ...
  methods: {
    ...
    lookDetail() {
      ...
      eleDetail(data).then((res) => {
        ...
        console.log(this.form, this.is_rea_ren);
      });
    },
  },
};
