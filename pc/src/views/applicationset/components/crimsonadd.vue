  ...
  <div class="main_bottom">
    ...
    <Maincontent>
      <div class="maincontent-col">
        <div class="maincontent-col-title">
        ...
        <div class="maincontent-col-content">
          <a-form-model-item>
            ...
            />
            <br />
            <label v-show="isok" style="color: #f33636"
              >* 请输入正确的模板名称</label
            >
          </a-form-model-item>
      ...
      <div
        class="maincontent-col"
        style="margin-top: 12px; padding-bottom: 25px"
      >
